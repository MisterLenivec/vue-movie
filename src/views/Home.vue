            ...
            <div class="container-fluid py-md-3">
                <div class="row">
                        ...
                        <div class="left-side my-4">
                            ...
                            <ul class="w3layouts-box-list">
                                <li class="editContent" >
                                    ...
                                    <span class="span editContentSpan" >Аниме</span>
                                </li>
                                    <li class="editContent" >
                                    <input type="checkbox" class="checked">
                                    <span class="span editContentSpan" >Боевики</span>
                                </li>
                                <li class="editContent" >
                                    <input type="checkbox" class="checked">
                                    <span class="span editContentSpan" >Комедии</span>
                                </li>
                                <li class="editContent" >
                                    <input type="checkbox" class="checked">
                                    <span class="span editContentSpan" >Ужасы</span>
                                </li>
                            </ul>
                        </div>
                        <div class="left-side">
                            ...
                            <ul class="w3layouts-box-list">
                                <li class="editContent" >
                                    <input type="checkbox" class="checked">
                                    <span class="span editContentSpan" >2020</span>
                                </li>
                            </ul>
                        </div>
                        <div class="customer-rev left-side my-4">
                            <h3 class="sear-head editContent">Рейтинг</h3>
                            <ul class="w3layouts-box-list editContentSpan">
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="fa fa-star" aria-hidden="true" ></span>
                                        <span class="fa fa-star" aria-hidden="true" ></span>
                                        <span class="editContentSpan" >5.0</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="editContentSpan" >4.0</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="fa fa-star-o" aria-hidden="true" ></span>
                                        <span class="editContentSpan" >3.5</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="fa fa-star-o" aria-hidden="true" ></span>
                                        <span class="fa fa-star-o" aria-hidden="true" ></span>
                                        <span class="editContentSpan" >3.0</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="fa fa-star-o" aria-hidden="true" ></span>
                                        <span class="fa fa-star-o" aria-hidden="true" ></span>
                                        <span class="editContentSpan" >2.5</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="left-ads-display col-lg-9">
                        <div class="row">
                            <div v-for="movie in listMovie" :key="movie.id" class="col-md-6 product-men">
